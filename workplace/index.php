...
<head>
    ...
    <link rel="profile" />
    <title>Aim Forever &#8211; Don&#039;t be aimless, target your best aim</title>
...
<body style="background:url(images/patterns/body-bg7.png);repeat-x;">
            ...
            <div class="col-sm-12">
                <nav class="navbar navbar-default" role="navigation">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"><span class="today-date">Thursday , October 11 2018</span> </a>
                    </div>
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="page-header">
                    <h1>Aim Forever</h1>
                    <p><span>Don&#039;t be aimless, target your best aim</span></p>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="row">
                           ...
                           <div class="row">
                            ...
                            <div class="content">
                                ...
                                <p>
                                    ...
                                    <span>Necessitatibus officiis sequi excepturi rem eveniet culpa optio sed corporis deleniti, iure consequuntur eaque dolor cum porro odio incidunt fuga expedita earum id,     <img class="img-responsive img-thumbnail pull-left" src="uploads/Business-Etiquette-Training-310x165.jpg" alt="Chania">voluptas illo error. Aspernatur molestias totam repellendus.</span>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <img class="img-responsive img-thumbnail" src="uploads/cox_chart-310x165.jpg" width="100%" alt="Chania">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <img class="img-responsive img-thumbnail" src="uploads/Business-Etiquette-Training-660x330.jpg" width="100%" alt="Chania">
                                </div>
                            </div>
                           <div class="row">
                                <div class="col-sm-12">
