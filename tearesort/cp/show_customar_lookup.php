    ...
    <div class="table-responsive">
      <table class="table table-striped b-t b-light table-hover">
        ...
        <tbody>
			<?php
				$num = 0;
				$select = mysqli_query($con,"SELECT client_id,first_name,surname,title,street_addr,phone,email,country FROM clients");
          ...
          <tr>
            ...
            <td><?php echo $data['street_addr'];?></td>
            <td><?php echo $data['phone'];?></td>
            <td><?php echo $data['email'];?></td>			
            <td><?php echo $data['country'];?></td>			
			 <td>
			 <center>
              <a href="edit_customer_lookup.php?edt=<?php echo $data['client_id'];?>" class="active" ui-toggle-class=""><i class="fa fa-edit text-success text-active"></i></a>
			  </center>
            </td>
          </tr>
		  <?
