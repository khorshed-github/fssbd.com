...
if(isset($_GET['del'])){
	...
	$sdel = mysqli_query($con,"DELETE FROM slider where id='$sid'");
...
<!DOCTYPE html>
<head>
<title>All Slider Images || Tea Resort & Museum</title>
    ...
    <div class="table-responsive">
      <table class="table table-striped b-t b-light table-hover">
        ...
        <tbody>
          ...
          <tr>
            <td><?php echo $num; ?></td>
            <td><img class="img-responsive img-rounded" style="max-height:50px" src="images/slider/<?php echo $data['image'];?>"></td>
            <td><?php echo $data['title'];?></td>
            <td><?php echo date("d-m-Y",strtotime($data['datetime']));?></td>
            <td>
              <a href="edit_slider.php?edt=<?php echo $data['id'];?>" class="active" ui-toggle-class=""><i class="fa fa-edit text-success text-active"></i></a>
            </td>
			<td>
