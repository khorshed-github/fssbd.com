...
$uploadOk = 0;
	...
	// if everything is ok, try to upload file
        if (move_uploaded_file($tmpName, $target_file)) {
			...
			mysqli_query($con,"INSERT INTO slider(title,image,userid,ip,datetime,status)
			VALUES('$title','$fileName','$loggedId','$ip',CURRENT_TIMESTAMP,1)");
...
<!DOCTYPE html>
<head>
<title>Add Slider Images || Tea Resort & Museum</title>
