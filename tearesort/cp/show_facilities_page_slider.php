...
if(isset($_GET['del'])){
	...
	$sdel = mysqli_query($con,"DELETE FROM facilities_slider where id='$sid'");
...
<!DOCTYPE html>
<head>
<title>All Facilities Slider Images || Tea Resort & Museum</title>
  ...
  <div class="panel panel-default">
	...
	<div class="row w3-res-tb">     
	  <div class="col-sm-6 m-b-xs">
        <select onchange="getFacilitiesSlider(this.value);" id="fatitle" class="input-md form-control w-md inline v-middle">
    ...
    <div class="table-responsive">
      <table class="table table-striped b-t b-light table-hover">
        ...
        <tbody id="allslider">
			...
			$num = 0;
			$select = mysqli_query($con,"SELECT * FROM facilities_slider");
			while($data = mysqli_fetch_array($select)){
				$num++;
			?>
		  <tr>
			<td><?php echo $num; ?></td>
			<td><img class="img-responsive img-rounded" style="max-height:50px" src="images/facilities_slider/<?php echo $data['image'];?>"></td>
			<td><?php echo $data['title'];?></td>
			<td><?php echo date("d-m-Y",strtotime($data['datetime']));?></td>
			<td>
			  <a href="edit_facilities_slider.php?edt=<?php echo $data['id'];?>" class="active" ui-toggle-class=""><i class="fa fa-edit text-success text-active"></i></a>
			</td>
			<td>
...
<script type="text/javascript">
		function getFacilitiesSlider(val){	
			$.ajax({
				type: "POST",
				url: "getFacilitiesSlider.php",
				data: 'fid='+val,
