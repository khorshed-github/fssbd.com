...
$uploadOk = 0;
	...
	// if everything is ok, try to upload file
        if (move_uploaded_file($tmpName, $target_file)) {
			...
			mysqli_query($con,"INSERT INTO gallery(aid,title,image,userid,ip,datetime,status)
			VALUES('$aid','$title','$fileName','$loggedId','$ip',CURRENT_TIMESTAMP,1)");
...
<!DOCTYPE html>
<head>
<title>Add Gallery || Tea Resort & Museum</title>
							...
							<?php } ?>
							   ...
							   <div class="form-group">
									<select class="form-control m-bot15" name="facid" required="required">
										...
										<?php
											$sqla = mysqli_query($con,"SELECT id,title FROM album");
											while($fraw = mysqli_fetch_array($sqla)){
										?>
                                ...
                                <div class="form-group">
                                    <label for="sliderTitle">Gallery Title</label>
