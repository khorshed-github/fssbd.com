...
$uploadOk = 0;
	...
	// if everything is ok, try to upload file
		...
		$submit = mysqli_query($con,"INSERT INTO `offer`(`offer_type`, `title`, `description`, `discount`, `start_date`, `end_date`, `image`, `sort_order`, `ip`, `userid`,`datetime`,  `status`) VALUES ('$type','$title','$description','$discount','$start_date','$end_date','$fileName','$sort_order','$loggedId','$ip',CURRENT_TIMESTAMP,1)");
...
<!DOCTYPE html>
<head>
<title>Add Offer Details || Tea Resort & Museum</title>
                        ...
                        <div class="panel-body">
							...
							<?php } ?>
							   ...
							   <div class="form-group">
                                    ...
                                    <input type="text" name="type" required="required" class="form-control" placeholder="Enter Offer Type">
                                </div>
								...
								<div class="col-md-6 form-group">
									...
									<input type="number" name="discount" placeholder=".col-md-4" class="form-control">
								</div>
								
								<div class="col-md-6 form-group">
									<label for="enddate">Offer Sorting</label>
									<select class="form-control" name="sort_order" required="required">
										<option value="1">Select Sorting</option>
										<?php
											$sqlf = mysqli_query($con,"SELECT id,title FROM offer");
											while($fraw = mysqli_fetch_array($sqlf)){
										?>
										<option value="<?php echo $fraw['id']+1;?>"><?php echo $fraw['title'];?></option>
										<?php
											}
										?>
									</select>
