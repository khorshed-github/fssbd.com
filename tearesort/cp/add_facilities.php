...
$uploadOk = 0;
	...
	// if everything is ok, try to upload file
        if (move_uploaded_file($tmpName, $target_file)) {	
			mysqli_query($con,"INSERT INTO facilities(title,description,image,userid,ip,datetime,status)
			VALUES('$title','$description','$fileName','$loggedId','$ip',CURRENT_TIMESTAMP,1)");
...
<!DOCTYPE html>
<head>
<title>Add Facilities || Tea Resort & Museum</title>
