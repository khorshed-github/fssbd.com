...
include("login_check.php");
	...
	$sdel = mysqli_query($con,"SELECT * FROM gallery WHERE id='$sid'");
	$objs = mysqli_fetch_object($sdel);
		$id = $objs->id;
		$title = $objs->title;
		$image = $objs->image;

//Gallery Images Edit Panel
...
$uploadOk = 0;
	...
	// if everything is ok, try to upload file
        if (move_uploaded_file($tmpName, $target_file)) {
			...
			mysqli_query($con,"UPDATE gallery SET title='$title',image='$fileName',userid='$loggedId',ip='$ip',datetime=CURRENT_TIMESTAMP WHERE id='$aid'");
...
<!DOCTYPE html>
<head>
<title>Edit Gallery Images || Tea Resort & Museum</title>
