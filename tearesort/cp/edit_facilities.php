...
include("login_check.php");
	...
	$sdel = mysqli_query($con,"SELECT * FROM facilities WHERE id='$sid'");
...
$uploadOk = 0;
	...
	// if everything is ok, try to upload file
       move_uploaded_file($tmpName, $target_file); 
		...
		$edt = mysqli_query($con,"UPDATE `facilities` SET `title`='$title', `description`='$description', `image`='$fileName', `userid`='$loggedId', `ip`='$ip', `datetime`=CURRENT_TIMESTAMP WHERE `id`='$fsid'");
...
<!DOCTYPE html>
<head>
<title>Edit Facilities || Tea Resort & Museum</title>
							...
							<?php } ?>
                               ...
                               <div class="alert alert-warning" role="alert">
                                 ...
                                 <div class="form-group">
									...
									<input type="submit" onclick="return confirm('Do you want to Edit?')" name="submit" class="btn btn-outline-info" value="UPLOAD" />
