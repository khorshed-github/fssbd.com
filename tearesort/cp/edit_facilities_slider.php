...
include("login_check.php");
	...
	$sdel = mysqli_query($con,"SELECT * FROM facilities_slider WHERE id='$sid'");
...
$uploadOk = 0;
	...
	// if everything is ok, try to upload file
        if (move_uploaded_file($tmpName, $target_file)) {
			...
			mysqli_query($con,"UPDATE facilities_slider SET title='$title',image='$fileName',userid='$loggedId',ip='$ip',datetime=CURRENT_TIMESTAMP WHERE id='$slid'");
...
<!DOCTYPE html>
<head>
<title>Edit Facilities Slider Images || Tea Resort & Museum</title>
