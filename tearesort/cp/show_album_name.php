...
if(isset($_GET['del'])){
	...
	$sdel = mysqli_query($con,"DELETE FROM album where id='$sid'");
    ...
    <div class="table-responsive">
      <table class="table table-striped b-t b-light table-hover">
        ...
        <tbody>
			<?php
				$num = 0;
				$select = mysqli_query($con,"SELECT id,title,datetime FROM album");
          ...
          <tr>
            ...
            <td>
              <a href="edit_album.php?edt=<?php echo $data['id'];?>" class="active" ui-toggle-class=""><i class="fa fa-edit text-success text-active"></i></a>
            </td>
			<td>
