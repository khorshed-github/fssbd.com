...
$uploadOk = 0;
	...
	// if everything is ok, try to upload file
       move_uploaded_file($tmpName, $target_file);	
			...
			$sendSql = mysqli_query($con,"INSERT INTO facilities_details(facilities_id,title,description,image,userid,ip,datetime,status)
			VALUES('$facid','$title','$description','$fileName','$loggedId','$ip',CURRENT_TIMESTAMP,1)");
...
<!DOCTYPE html>
<head>
<title>Add Facilities Details || Tea Resort & Museum</title>
                        ...
                        <div class="panel-body">
							...
							<?php } ?>
							   ...
							   <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Facilities Title</label>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <textarea name="description" required="required" class="form-control" placeholder="Enter title"></textarea>
                                </div>
                                <div class="form-group">
