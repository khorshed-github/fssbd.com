	...
	<div class="home-landing scrollable">
		...
		<div class="offers-page" style="background:#f5f5f5;">
            <div class="container offer-container">                
				...
				<?php
					$sqlOffer = mysqli_query($con,"SELECT * FROM meeting_events");
					if(mysqli_num_rows($sqlOffer)==!0){
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="package-text-container offer-text-container">
                            ...
                            <h4 class="offer-date">Valid From <?php echo date("d M Y",strtotime($queryRow['start_date']));?> To <?php echo date("d M Y",strtotime($queryRow['end_date']));?></h4>
                    ...
                    <div class="col-md-6 dot-line-right-big">
                        <div class="dot-line-right">
                            <img src="cp/images/meeting-events/<?php echo $queryRow['image'];?>" alt="<?php echo $queryRow['title'];?>">
                        </div>
                    </div>
                </div>                
				<?php
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="dot-line-left offers-dot-line-left">
                            <img src="cp/images/meeting-events/<?php echo $queryRow['image'];?>" class="img-responsive" alt="<?php echo $queryRow['title'];?>">
                        </div>
                    </div>
                    <div class="col-md-6">
               ...
               <?php 
					...
					echo "<center><h1>No Meetings or Events Just Now.!!</h1></center>";
				}
			   ?>
